...
function GameMode:_InitGameMode()
  ...
  GameRules:GetGameModeEntity():SetCustomAttributeDerivedStatValue(DOTA_ATTRIBUTE_STRENGTH_HP, 20.0)
  ...
  --GameRules:GetGameModeEntity():SetCustomAttributeDerivedStatValue(DOTA_ATTRIBUTE_STRENGTH_MAGIC_RESISTANCE_PERCENT, 0.0005555) -- From 12.5 Str per 1% MR to 18 Str per 1% MR
  ...
  --GameRules:GetGameModeEntity():SetCustomAttributeDerivedStatValue(DOTA_ATTRIBUTE_INTELLIGENCE_SPELL_AMP_PERCENT, 0.0625)  --used modifier to give 1% spell amp per 18 int
