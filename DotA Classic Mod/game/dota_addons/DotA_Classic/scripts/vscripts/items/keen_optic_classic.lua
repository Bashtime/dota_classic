--Class Definitions
	...
	item_keen_optic_classic = class({})
	local itemClass = item_keen_optic_classic

	--Passive instrinsic Bonus Modifier
	modifier_keen_classic = class({})
	local modifierClass = modifier_keen_classic
	local modifierName = 'modifier_keen_classic'
	LinkLuaModifier(modifierName, "items/keen_optic_classic", LUA_MODIFIER_MOTION_NONE)
