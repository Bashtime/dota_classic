--Class Definitions
	...
	item_titan_classic = class({})
	local itemClass = item_titan_classic

	--Passive instrinsic Bonus Modifier
	modifier_titan_classic = class({})
	local modifierClass = modifier_titan_classic
	local modifierName = 'modifier_titan_classic'
	LinkLuaModifier(modifierName, "items/titan_classic", LUA_MODIFIER_MOTION_NONE)
...
function modifierClass:OnCreated()
	...
	self.bonus_mr = self:GetAbility():GetSpecialValueFor( "magic_resistance" )
	...
	self.basedmg_amp = self:GetAbility():GetSpecialValueFor( "base_attack_damage" )
