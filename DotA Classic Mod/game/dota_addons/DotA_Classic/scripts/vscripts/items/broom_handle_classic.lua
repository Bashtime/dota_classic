--Class Definitions
	...
	item_broom_handle_classic = class({})
	local itemClass = item_broom_handle_classic

	--Passive instrinsic Bonus Modifier
	modifier_broom_handle_classic = class({})
	local modifierClass = modifier_broom_handle_classic
	local modifierName = 'modifier_broom_handle_classic'
	LinkLuaModifier(modifierName, "items/broom_handle_classic", LUA_MODIFIER_MOTION_NONE)
...
function modifierClass:OnCreated()
	...
	self.bonus_range = self:GetAbility():GetSpecialValueFor( "bonus_range" )
			...
			function modifierClass:DeclareFunctions()
				...
				function modifierClass:GetModifierAttackRangeBonusUnique()
					local caster = self:GetParent()
