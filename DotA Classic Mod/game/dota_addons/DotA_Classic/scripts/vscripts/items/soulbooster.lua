--Class Definitions
	...
	item_soulbooster = class({})
	local itemClass = item_soulbooster

	--Passive instrinsic Bonus Modifier
	modifier_booster = class({})
	local modifierClass = modifier_booster
	local modifierName = 'modifier_booster'
	LinkLuaModifier(modifierName, "items/soulbooster", LUA_MODIFIER_MOTION_NONE)
