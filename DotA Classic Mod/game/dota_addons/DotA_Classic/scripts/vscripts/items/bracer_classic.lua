--Class Definitions
	...
	item_bracer_classic = class({})
	local itemClass = item_bracer_classic

	--Passive instrinsic Bonus Modifier
	modifier_bracer_classic = class({})
	local modifierClass = modifier_bracer_classic
	local modifierName = 'modifier_bracer_classic'
	LinkLuaModifier(modifierName, "items/bracer_classic", LUA_MODIFIER_MOTION_NONE)
