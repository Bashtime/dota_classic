...
AP_GAME_TIME = 60.0					-- How long after people select their heroes should the horn blow and the game start?
...
--HERO_INITIAL_GOLD = 625					-- Not working
GOLD_TICK_TIME = 0.6
...
MINIMUM_ATTACK_SPEED = 15               -- What should we use for the minimum attack speed?
